        ...
        <div class="card radius-10">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div>
                <form action="<?php echo site_url('kepala_dinas/populasi/klasifikasi'); ?>" method="post">
                        <table class="table table-striped table-bordered dt-responsive nowrap" width="100%">
                            <thead>
                                ...
                                Klasifikasi : <select name="jenis_klasifikasi" id="select" required class="form-control">
                            <option value="">-- Pilih Klasifikasi --</option>
                            <option value="pemilik_ternak.nm_pemilik">Pemilik</option>
                            <option value="populasi.status_kepemilikan">Status Kepemilikan</option>
                            <option value="populasi_detail.umur_hewan">Umur Hewan</option>
                            <option value="populasi_detail.jk_hewan">Jenis Kelamin</option>
                </select> 
...
?>
   ...
   <?php }?>
                    ...
                    <a href="javascript:printDiv('box');">
                                ...
                                <a href="<?php echo site_url();?>kepala_dinas/populasi/klasifikasi">
                                            <button type="button" class="btn btn-primary waves-effect waves-light">
            ...
            <hr/>
            <div id="box">
<center><h4>LAPORAN POPULASI TERNAK MENURUT <?=strtoupper($jenisKlasifikasi);?><br>
             <?=$bulanShow;?> <?=$tahunShow;?>
