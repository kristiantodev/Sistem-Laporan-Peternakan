        ...
        <div class="card radius-10">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <div>
                <form action="<?php echo site_url('kepala_dinas/populasi'); ?>" method="post">
                        <table class="table table-striped table-bordered dt-responsive nowrap" width="100%">
                            <thead>
                                <tr>
                                  <td>
                                    Pilih Kecamatan : <select name="id_kecamatan" id="select" required class="form-control">
...
<center><h4>LAPORAN POPULASI TERNAK MENURUT JENISNYA<br>
             <?=$bulanShow;?> <?=$tahunShow;?>
                        ...
                        <?php if ($kecamatanShow != 0) {?>

                          <?php 
                  $kecDetail = $this->db->query("SELECT*FROM kecamatan WHERE id_kecamatan='$kecamatanShow'")->row();
                    ?> <?=$kecDetail->nm_kecamatan ?>
